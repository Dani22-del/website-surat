<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <ul class="navbar-nav align-items-center ms-auto flex-row">
            ...
            <!-- Quick links  -->
            <li class="nav-item dropdown-shortcuts navbar-dropdown dropdown me-xl-0 me-1">
                <a class="nav-link btn btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow"
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    @if (Auth::check())
                                        <span class="fw-medium d-block small">{{ Auth::user()->name }}</span>
                                         ...
                                         <small class="text-muted">Admin Perusahaan</small>    
                                         @endif
                    ...
                    <li>
                        <a class="dropdown-item" href="pages-account-settings-billing.html">
                            <span class="d-flex align-items-center align-middle">
                                <i class="ri-file-text-line ri-22px me-3 flex-shrink-0"></i>
                                <span class="flex-grow-1 align-middle">Billing</span>
                                <span class="badge badge-center rounded-pill bg-danger flex-shrink-0">4</span>
                            </span>
                        </a>
                    </li>
                    <li>
