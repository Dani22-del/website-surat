...
<div class="row gy-4">
      ...
      <div class="row">
        ...
        <div class="col-md-7 col-12 order-2 order-md-0">
          <div class="card-header">
            <h4 class="mb-3"><b>Custommers</b></h4>
            <p>Total</p>
            <h2 class="mb-0 mt-4" style="color: #6f42c1">2.600</h2>
            <p>Custommers</p>
          </div>
        </div>
        <div class="col-md-5 col-12 mt-3">
          <img src="{{ asset('assets/img/natusi/sales_icon.png') }}" width="130" height="150" alt="">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="card p-2">
      <div class="card-header pb-2">
        <div class="d-flex align-items-end mb-1 flex-wrap gap-2">
          <img src="{{ asset('assets/img/natusi/icon.png') }}" width="50" height="50" alt="">
        </div>
        {{-- <span class="d-block mb-2 text-muted">Sessions</span> --}}
      </div>
      <div class="card-body">
        <h4 class="mt-4"><b>1.102</b></h4>
        <h6 class="text-muted"><b>Produk</b></h6>
        {{-- <div id="sessions"></div> --}}
      </div>
    </div>
  </div>
  ...
  <div class="col-4 col-xl-2">
    <div class="card p-2">
      ...
      <div class="card-body">
        <h4 class="mt-4"><b>14</b></h4>
        <h6 class="text-muted"><b>Sales Order</b></h6>
        {{-- <div id="sessions"></div> --}}
      </div>
    </div>
  </div>
  ...
  <div class="col-4 col-xl-2">
    <div class="card p-2">
      ...
      <div class="card-body">
        <h4 class="mt-4"><b>900</b></h4>
        <h6 class="text-muted"><b>Retur</b></h6>
        {{-- <div id="sessions"></div> --}}
      </div>
    </div>
  </div>
  ...
  <div class="col-4 col-xl-2">
    <div class="card p-2">
      ...
      <div class="card-body">
        <h4 class="mt-4"><b>28</b></h4>
        <h6 class="text-muted"><b>Piutang</b></h6>
        {{-- <div id="sessions"></div> --}}
      </div>
    </div>
  </div>
  ...
  <div class="col-12 col-xl-4">
    <div class="card p-2">
      ...
      <div class="card-body">
        <h4 class="mt-4"><b>900</b></h4>
        <h6 class="text-muted"><b>Schedule Driver</b></h6>
        {{-- <div id="sessions"></div> --}}
      </div>
    </div>
  </div>
  ...
  <div class="col-12 col-xl-4">
    <div class="card p-2">
      ...
      <div class="card-body">
        <h4 class="mt-4"><b>28</b></h4>
        <h6 class="text-muted"><b>Tidak Order</b></h6>
        {{-- <div id="sessions"></div> --}}
      </div>
    </div>
  </div>
  ...
  <div class="col-12 col-xl-4">
    <div class="card p-2">
      <div class="row">
        <div class="col-md-7 col-12 order-2 order-md-0">
          <div class="card-header">
            <h4 class="mb-3"><b>Pembayaran</b></h4>
            <p>Total</p>
            <h2 class="mb-0 mt-4" style="color: #6f42c1">2.600</h2>
            <p>Pembayaran</p>
          </div>
